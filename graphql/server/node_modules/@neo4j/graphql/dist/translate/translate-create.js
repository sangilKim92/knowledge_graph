...
function translateCreate({ context, node }) {
    ...
    const { fieldsByTypeName } = Object.values(resolveTree.fieldsByTypeName[`Create${pluralize_1.default(node.name)}MutationResponse`]).find((field) => field.name === pluralize_1.default(camelcase_1.default(node.name)));
