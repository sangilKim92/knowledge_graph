...
const ErrUnsupportedFeature = (feature) => core_schema_1.err('UnsupportedFeature', {
...
const ErrForUnsupported = (core, ...features) => core_schema_1.err('ForUnsupported', {
...
function featureSupport() {
    ...
    if (coreVersionZeroDotOne) {
        ...
        if (purposefulFeatures.length > 0)
            this.report(exports.ErrForUnsupported(coreVersionZeroDotOne, ...purposefulFeatures));
    }
    for (const feature of this.features) {
        ...
        if (feature.purpose === 'EXECUTION' || feature.purpose === 'SECURITY') {
            if (!SUPPORTED_FEATURES.has(feature.url.base.toString())) {
                this.report(exports.ErrUnsupportedFeature(feature));
            }
        }
    }
}
